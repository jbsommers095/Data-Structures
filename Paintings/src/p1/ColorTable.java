 ...
 ColorTable table = this;
  ...
  public static void main(String[] args) {
   ...
   table.put(Color.WHITE, 5);
     ...
     //System.out.println(table);
     //System.out.println(table.get(Color.RED));*/
     ColorTable table = new ColorTable(13, 5, Constants.LINEAR, 0.49);
     int index = 0;
     for (int i = 0; i < 20 * 17; i += 17) {
       //System.out.println(table.getCountAt(index));
       table.put(new Color(i * i),  i);
       index++;
     }
     //System.out.println(table);
     System.out.println(Util.cosineSimilarity(table, table));
  }
}
