...
public class Testing {
  ...
  @Test
  // Custom test to check for ft.put with empty strings
  public void smallFreqTable2() {
	  FrequencyTable ft = new FrequencyTable();
	  ft.put('a', 1);
	  ft.put('b', 2);
	  ft.put('c', 3);
  ...
  //@Test Tree looks different than test, new test in catInHat2()
  ...
  public void catInHat2() {
	    ...
	    assertTrue(4 == ht.root.left.left.priority);
	    assertTrue(4 == ht.root.left.right.priority);
	    assertTrue(2 == ht.root.right.left.left.priority);
	    assertTrue(2 == ht.root.right.left.right.priority);
	    assertTrue(3 == ht.root.right.right.left.priority);
	    assertTrue(1 == ht.root.right.right.right.left.priority);
	    assertTrue(2 == ht.root.right.right.right.right.priority);
	    assertTrue(6 == ht.root.right.right.priority);
	    ...
	    assertTrue(1 == ht.root.right.right.right.left.priority);
	    assertTrue(2 == ht.root.right.right.right.right.priority);
	    assertEquals("00", ht.lookup('T'));
	    assertEquals("110", ht.lookup('H'));
	    assertEquals("100", ht.lookup('E'));
	    assertEquals("11110", ht.lookup('C'));
	    assertEquals("101", ht.lookup('A'));
	    assertEquals("1110", ht.lookup('I'));
	    assertEquals("11111", ht.lookup('N'));
	    assertEquals("01", ht.lookup(' '));
	    assertEquals('T', ht.decodeChar("00"));
	    assertEquals('H', ht.decodeChar("110"));
	    assertEquals('E', ht.decodeChar("100"));
	    assertEquals('C', ht.decodeChar("11110"));
	    assertEquals('A', ht.decodeChar("101"));
	    assertEquals('I', ht.decodeChar("1110"));
	    assertEquals('N', ht.decodeChar("11111"));
	    assertEquals(' ', ht.decodeChar("01"));
	    assertEquals('T', ht.decodeChar("000000000"));
	    assertEquals('H', ht.decodeChar("1100000000000"));
	    assertEquals('E', ht.decodeChar("100000000000000"));
	    assertEquals('C', ht.decodeChar("111100000000000"));
	    assertEquals('A', ht.decodeChar("1010000000000000000"));
	    assertEquals('I', ht.decodeChar("111000000000000000000000"));
	    assertEquals('N', ht.decodeChar("111110000000000"));
	    assertEquals(' ', ht.decodeChar("01000000000000"));
	  }
